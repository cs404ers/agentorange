...
public class AgentCA2 extends Agent{
    /**
    ...
    public AgentCA2() {
	 ...
	 protected void messageReceived(Message message) {
	        ...
	        System.out.println("(AgentCA2): Message Received");
	    ...
	    protected void sendBidAndAds() {
          ...
          for(Query query : querySpace) {
              ...
              //miss-neutral
                ...
                {
                  bid = 1.05*(getVPC(query)-getCPC(query));
                } 
              //hit   
              else if ((query.getManufacturer().equals(advertiserInfo.getManufacturerSpecialty())) && (query.getComponent().equals(advertiserInfo.getComponentSpecialty())))
                {
                  bid = 1.25*(getVPC(query)-getCPC(query));
                }   
