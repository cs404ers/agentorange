...
public class AgentMA4 extends Agent{
    /**
    ...
    public AgentMA4() {
	 ...
	 protected void messageReceived(Message message) {
	        ...
	        System.out.println("(AgentMA4): Message Received");
              ...
              if (query.equals(qPA))
                {
                  ...
                  bid = aPA*(getVPC(query)-getCPC(query));
              ...
              else if (query.equals(qPD))
               {
                  ...
                  bid = aPD*(getVPC(query)-getCPC(query));
              ...
              else if (query.equals(qPT))
                {
                  ...
                  bid = aPT*(getVPC(query)-getCPC(query));
              ...
              else if (query.equals(qFA))
                {
                  ...
                  bid = aFA*(getVPC(query)-getCPC(query));
              ...
              else if (query.equals(qFD))
                {
                  ...
                  bid = aFD*(getVPC(query)-getCPC(query));
              ...
              else if (query.equals(qFT))
                {
                  ...
                  bid = aFT*(getVPC(query)-getCPC(query));
              ...
              else if (query.equals(qLA))
                {
                  ...
                  bid = aLA*(getVPC(query)-getCPC(query));
              ...
              else if (query.equals(qLD))
                {
                  ...
                  bid = aLD*(getVPC(query)-getCPC(query));
              ...
              else if (query.equals(qLT))
                {
                  ...
                  bid = aLT*(getVPC(query)-getCPC(query));
